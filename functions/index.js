...
exports.returnVenues = functions.https.onRequest((req, res) => {
  //Import Libraries
  ...
  function () {
    var _ref = _asyncToGenerator(function* (venueId) {
      try {
        ...
        return response.data; //.response.venue; //attempt at parsing
      } catch (error) {
        console.error(error);
        return null;
      }
  ...
  const johnVenues = _asyncToGenerator(function* () {
    yield getAllVenues(johnLatLong, DRIVE, FOOD_GENERAL, 20);
  })();
